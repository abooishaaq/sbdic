...
func (gc *GroupCreate) AddGroupItemIDs(ids ...int) *GroupCreate {
	gc.mutation.AddGroupItemIDs(ids...)
	return gc
}

// AddGroupItems adds the "group_items" edges to the Item entity.
func (gc *GroupCreate) AddGroupItems(i ...*Item) *GroupCreate {
	ids := make([]int, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
	return gc.AddGroupItemIDs(ids...)
}
...
func (gc *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if nodes := gc.mutation.GroupItemsIDs(); len(nodes) > 0 {
