...
type GroupEdges struct {
	...
	GroupItems []*Item `json:"group_items,omitempty"`
	// loadedTypes holds the information for reporting if a
	// type was loaded (or requested) in eager-loading or not.
	loadedTypes [1]bool
}

// GroupItemsOrErr returns the GroupItems value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) GroupItemsOrErr() ([]*Item, error) {
	if e.loadedTypes[0] {
		return e.GroupItems, nil
	}
...
func (*Group) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case group.FieldTitle, group.FieldDesc:
...
// QueryGroupItems queries the "group_items" edge of the Group entity.
func (gr *Group) QueryGroupItems() *ItemQuery {
	return (&GroupClient{config: gr.config}).QueryGroupItems(gr)
}
